  ...
  return (
    <nav className="w-full bg-white shadow-md fixed top-0 left-0 z-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 flex justify-between items-center">
        ...
        <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-500">Rawjatul Jannat Lamia</h1>
        ...
        <button className="md:hidden text-2xl text-gray-700" onClick={() => setMenuOpen(!menuOpen)}><HiMenu></HiMenu></button>
      </div>


       {menuOpen && (        
        <div className="md:hidden bg-white shadow-md px-4 pb-4">         
         <ul className="flex flex-col gap-4 text-gray-700 font-medium">            <li>             
           ...
           <li>              
            <button onClick={() => scrollToSection("about")} className="hover:text-blue-600">About</button>           
             ...
             <li>              
              <button onClick={() => scrollToSection("tech")} className="hover:text-blue-600">Tech Stack</button>           
               </li>           
                <li>             
